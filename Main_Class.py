...
class Application():
    def __init__(self, root):
        ...
        self.creer_titres = ttk.Label(root, text = "Projet tutore 2A \n Analyse des données NBA \n Parmentier ; Makké ; Lebreton ; Messina")
        self.creer_bouton_1 = tk.Button(root, text = "Accèder aux analyses", command = self.menu_2) 
    ...
    def menu_2(self):
        ...
        self.bouton_1 = tk.Button(root, image = ATL)
    ...
    def menu_3(self, equipe):
        ...
        self.df = pandas.read_csv(chemin,index_col=0)
        ...
        self.t = ImageTk.PhotoImage(Image.open(listechemin[19]))



        # Ajouter l'image dans le bouton 
        self.bouton_1 = tk.Button(root, image = self.a)
        self.bouton_1.grid(row = 0, column = 0)
        self.bouton_2 = tk.Button(root, image = self.b)
        self.bouton_2.grid(row = 0, column = 1)
        self.bouton_3 = tk.Button(root, image = self.c)
        self.bouton_3.grid(row = 0, column = 2)
        self.bouton_4 = tk.Button(root, image = self.d)
        self.bouton_4.grid(row = 0, column = 3)
        self.bouton_5 = tk.Button(root, image = self.e)
        self.bouton_5.grid(row = 0, column = 4)
        self.bouton_6 = tk.Button(root, image = self.f)
        self.bouton_6.grid(row = 1, column = 0)
        self.bouton_7 = tk.Button(root, image = self.g)
        self.bouton_7.grid(row = 1, column = 1)
        self.bouton_8 = tk.Button(root, image = self.h)
        self.bouton_8.grid(row = 1, column = 2)
        self.bouton_9 = tk.Button(root, image = self.i)
        self.bouton_9.grid(row = 1, column = 3)
        self.bouton_10 = tk.Button(root, image = self.j)
        self.bouton_10.grid(row = 1, column =4)
        self.bouton_11 = tk.Button(root, image = self.k)
        self.bouton_11.grid(row = 2, column = 0)
        self.bouton_12 = tk.Button(root, image = self.l)
        self.bouton_12.grid(row = 2, column = 1)
        self.bouton_13 = tk.Button(root, image = self.m)
        self.bouton_13.grid(row = 2, column = 2)
        self.bouton_14 = tk.Button(root, image = self.n)
        self.bouton_14.grid(row = 2, column = 3)
        self.bouton_15 = tk.Button(root, image = self.o)
        self.bouton_15.grid(row = 2, column = 4)
        self.bouton_16 = tk.Button(root, image = self.p)
        self.bouton_16.grid(row = 3, column = 0)
        self.bouton_17 = tk.Button(root, image = self.q)
        self.bouton_17.grid(row = 3, column = 1)
        self.bouton_18 = tk.Button(root, image = self.r)
        self.bouton_18.grid(row = 3, column = 2)
        self.bouton_19 = tk.Button(root, image = self.s)
        self.bouton_19.grid(row = 3, column = 3)
        self.bouton_20 = tk.Button(root, image = self.t)
        self.bouton_20.grid(row = 3, column = 3)
