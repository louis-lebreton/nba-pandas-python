...
def menu_2():
    ...
    bouton_app_1 = tk.Button(app, text = "1 . NBA 2021-22", command = lambda:[ DataFrame_NBA_saison(1), menu_3()])
    bouton_app_2 = tk.Button(app, text = "2 . NBA 2020-21", command = lambda:[ DataFrame_NBA_saison(2), menu_3()])
    bouton_app_3 = tk.Button(app, text = "3 . NBA 2019-20", command = lambda:[ DataFrame_NBA_saison(3), menu_3()])
    bouton_app_4 = tk.Button(app, text = "Retour" , command = menu_1)
...
def menu_3():
    ...
    bouton_app_1 = tk.Button(app, text = "1 . Statistiques individuelles :" , command = menu_3_choix1)
    bouton_app_2 = tk.Button(app, text = "2 . Statistiques des équipes :", command = menu_3_choix2)
    bouton_app_3 = tk.Button(app, text = "Retour" , command = menu_2)
...
def menu_3_choix1():
    ...
    bouton_app_4 = tk.Button(app, text = "Retour" , command = menu_3)
...
def menu_3_choix2():
    ...
    bouton_app_1 = tk.Button(app, text = "1 . Les 10 meilleurs équipes : scores :", command = menu_3_choix2_rep1)
    bouton_app_4 = tk.Button(app, text = "Retour" , command = menu_3)
