...
def Scraping_ficheindiv_from_lien(site_team): 
    #l'url ou chercher les données : site_team
    ...
    #Pour cela on scrap la balise "span" dans la balise "h1"
    ...
    #On récupère l'ensemble du contenu des balises "p"
...
#à partir du lien de la page de l'ensemble joueurs
