...
import os
import fonctions_scrap_image


#choix de la page
######################################################################
######################################################################
lienpage='https://www.basketball-reference.com/leagues/NBA_2020.html'
######################################################################
######################################################################
...
for i in range(9):
    ...
    lienimage=fonctions_scrap_image.Scraping_liens_images_teams(i,lienpage)
